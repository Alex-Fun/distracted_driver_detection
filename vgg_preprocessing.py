...
def _crop(image, offset_height, offset_width, crop_height, crop_width):
    ...
    size_assertion = tf.Assert(
        ...
        ['_crop() Crop size greater than the image size. crop_height:{},crop_width:{}'.format(crop_height, crop_width)])
...
def _random_crop(image_list, crop_height, crop_width):
    ...
    print('preprocess_for_train._random_crop, image_shape:%, image_shape:% crop_height:% , crop_width:%', image_shape, image_shape, crop_height, crop_width)
    crop_size_assert = tf.Assert(
        tf.logical_and(
            tf.greater_equal(image_height, crop_height),
            tf.greater_equal(image_width, crop_width)),
        ['_random_crop() Crop size greater than the image size. crop_height:{},crop_width:{}'.format(crop_height, crop_width)])
...
def _central_crop(image_list, crop_height, crop_width):
    ...
    for image in image_list:
        ...
        print('preprocess_for_eval._central_crop, crop_height:% , crop_width:%', crop_height, crop_width)
...
def preprocess_for_train(image,
    ...
    print('preprocess_for_train, output_height:% , output_width:%', output_height, output_width)
...
def preprocess_for_eval(image, output_height, output_width, resize_side,
    ...
    print('preprocess_for_eval, output_height:% , output_width:%', output_height, output_width)
...
def preprocess_images(images, output_height, output_width, is_training=False,
    ...
    Args:
        ...
        resize_side_max: The upper bound for the smallest side of the image
            ...
            [resize_size_min, resize_size_max].
        border_expand:If `True`, expands the given image.
        normalize:If `True`, normalizes an image.
        preserving_aspect_ratio_resize:If `True`, resize images preserving
            the original aspect ratio, otherwise, resize images by fixed sides.
